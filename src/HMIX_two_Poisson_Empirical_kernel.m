...
% for reference: discrete poisson kernel density estimation - with an
% application to wildcat coal strikes
...
function [z] = HMIX_two_Poisson_Empirical_kernel(Y, theta0)
