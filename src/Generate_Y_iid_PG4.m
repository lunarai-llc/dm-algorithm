...
function [Y] = Generate_Y_iid_PG4(true_theta, n)

% true_pi1 = 0.4; true_alpha1 = 20; true_beta1 = 1.5; 
% true_pi2 = 0.3; true_alpha2 = 10; true_beta2 = 1; 
% true_pi3 = 0.2; true_alpha3 = 5; true_beta3 = 2;
%                 true_alpha4 = 1; true_beta4 = 1;
% 
% n = 10000; 
% 
% true_theta = [true_pi1 true_alpha1 true_beta1 true_pi2 true_alpha2 ...
%               true_beta2 true_pi3 true_alpha3 true_beta3 ...
%               true_alpha4 true_beta4 ];  
...
true_alpha4 = true_theta(10);
true_beta4 = true_theta(11);
