...
% this is to use EM type algorithm for NED method to implement iid PG model
...
% the update for pi is new.

% EM algorithm 

% COMMENT: WORKS WELL and use substitutional principle, USE THIS ONE!

% this is exactly the same as EM3_iid_PG_NED(Y, theta0)

function [z] = EM_iid_PG2_NED(Y, theta0) 
